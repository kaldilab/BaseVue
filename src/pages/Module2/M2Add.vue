      ...
      <div class="add__body">
        <form @submit.prevent="boardAdd">
          <div class="form-group">
            ...
            <select v-model="category" v-if="categoryList" class="form-select" id="exampleInput4">
...
export default {
  ...
  methods: {
    ...
    boardAdd() {
      ...
      if (this.title && this.content && this.nick_name && this.category) {
        this.$api
          .postBoardNews(this.title, this.content, this.nick_name, this.category)
          .then((response) => {
          ...
          .then((response) => {
            ...
            this.$router.push(`/module2/view_m2card/${id}`).catch(() => {});
          })
