  ...
  <div v-frag>
    <section class="section view">
      ...
      <div class="view__top">
        <div class="btn-group">
          <router-link
            ...
            :to="`/module2/edit_m2${$route.path.match($route.matched[1].regex)[1]}/${$route.params.id}`"
          >
            수정
          </router-link>
            ...
            <ul class="view__article--prevnext">
              <li class="list-group list-group-flush">
                <router-link
                  ...
                  :to="{
                    path: `/module2/view_m2${$route.path.match($route.matched[1].regex)[1]}/${boardView.prev_document_srl}`,
                  }"
              ...
              <li class="list-group list-group-flush border-top">
                <router-link
                  ...
                  :to="{
                    path: `/module2/view_m2${$route.path.match($route.matched[1].regex)[1]}/${boardView.next_document_srl}`,
                  }"
                  class="list-group-item list-group-item-action"
                >
                  <div class="d-flex w-100 justify-content-between">
      ...
      <div class="view__bottom">
        <router-link
          v-if="$route.path.match($route.matched[1].regex)[1] === 'card'"
          class="btn btn-primary"
          :to="{
            path: `/module2/m2${$route.path.match($route.matched[1].regex)[1]}`,
        ...
        <router-link
          ...
          :to="{
            path: `/module2/m2${$route.path.match($route.matched[1].regex)[1]}`,
            query: { paging: $route.query.paging, category: $route.query.category },
          }"
        >
          목록 보기
        </router-link>
...
export default {
  ...
  created() {
    window.scroll(0, 0);
    this.$store.dispatch("actionBoardViewNews", {
  ...
  methods: {
    boardDelete() {
      if (window.confirm("정말로 삭제하시겠습니까?")) {
        this.$api
          .deleteBoardNews(this.$route.params.id)
          .then((response) => {
          ...
          .then(() => {
            this.$router.push(
              `/module2/m2${this.$route.path.match(this.$route.matched[1].regex)[1]}`
            ).catch(() => {});
          })
  ...
  computed: {
    boardView() {
      return this.$store.state.BoardViewNews.info;
    },
  },
  watch:{
