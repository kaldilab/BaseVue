        ...
        <div class="view__article--inner" v-else>
          <div class="view__article--body">
            <div class="view__article--cont">
              ...
              <p class="lead">{{ boardView.title }}</p>
            ...
            <ul class="view__article--prevnext">
              <li class="list-group list-group-flush">
                <router-link
                  ...
                  :to="{
                    path: `/module3/view_m3masonry/${boardView.prev_document_srl}`,
                  }"
              ...
              <li class="list-group list-group-flush border-top">
                <router-link
                  ...
                  :to="{
                    path: `/module3/view_m3masonry/${boardView.next_document_srl}`,
                  }"
                  class="list-group-item list-group-item-action"
                >
                  <div class="d-flex w-100 justify-content-between">
...
export default {
  ...
  created() {
    window.scroll(0, 0);
    this.$store.dispatch("actionBoardViewLive", {
      id: this.$route.params.id,
    });
  },
  computed: {
    boardView() {
      return this.$store.state.BoardViewLive.info;
    },
  },
  watch:{
