            ...
            <ul class="view__article--prevnext">
              <li class="list-group list-group-flush">
                <router-link
                  ...
                  :to="{
                    path: `/module3/view_m3type/${boardView.prev_document_srl}`,
                  }"
              ...
              <li class="list-group list-group-flush border-top">
                <router-link
                  ...
                  :to="{
                    path: `/module3/view_m3type/${boardView.next_document_srl}`,
                  }"
                  class="list-group-item list-group-item-action"
                >
                  <div class="d-flex w-100 justify-content-between">
...
export default {
  ...
  created() {
    window.scroll(0, 0);
    this.$store.dispatch("actionBoardViewCoin", {
      id: this.$route.params.id,
    });
  },
  computed: {
    boardView() {
      return this.$store.state.BoardViewCoin.info;
    },
  },
  watch:{
